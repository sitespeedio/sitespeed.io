...
### Added
* Upgraded to [fourth alpha of Browsertime 6.0.0](https://github.com/sitespeedio/browsertime/blob/master/CHANGELOG.md#600-alpha2---2019-08-15). Chromedriver is updated to 77 so you should probably update Chrome to use Chrome 77 beta.
