...
* Graphite keys now replaces pipe, comma and plus. If your URL:s hand them, they will now be replaced by _. The reason is that some Grafana functions don't work with the special characters. Thanks @EikeDawid for the PR! #679
