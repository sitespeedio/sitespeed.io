...
* The side-by-side runs page got the modern card treatment and tints the best and worst value per metric so an unstable run jumps out; run navigation is now pills with the current run highlighted, and all tabs share the same jump-link style [#4820](https://github.com/sitespeedio/sitespeed.io/pull/4820).
