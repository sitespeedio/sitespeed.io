...
But first lets chek what we have added the last months:
...
We have a Slack channel for developers, you can get invited by sending a email to peter[AT]soulgalore[dot]com. There you can get help with building plugins or if you want to contribute to sitespeed.io. If you have questions how to run sitespeed.io, please use [Github issues](https://github.com/sitespeedio/sitespeed.io/issues/new).
