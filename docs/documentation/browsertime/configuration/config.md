...
timeouts
      ...
      --timeouts.elementWait                       Timeout when waiting for an element to appear before interacting with it (click, addText etc), in milliseconds. Default is 6000 (6 seconds). Set to 0 to disable.  [number] [default: 6000]
...
safari
      ...
      --safari.includeResponseBodies  Include response bodies in HAR for Safari iOS. "none" (default), "html", or "all".  [default: "none"]
