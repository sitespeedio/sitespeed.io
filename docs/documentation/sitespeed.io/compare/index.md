...
3. **Median → median**: the baseline and current medians with the difference in absolute numbers and percent. When the medians show the same value but the runs differ (flaky CPU long tasks do this), the means are shown instead.
