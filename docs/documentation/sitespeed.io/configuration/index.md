...
Browser
  ...
  --browsertime.connectivity.engine                            The engine for connectivity. TSProxy needs Python 2.7. TC (Linux Traffic Control) needs tc work. If you run
                                                               inside Docker use tc.                                             [choices: "tc", "tsproxy"] [default: "tsproxy"]
