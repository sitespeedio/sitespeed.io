...
function analyzeUrl(args, asyncDoneCallback) {
  ...
  log.log('info', 'Running YSlow for ' + url +  ' ' + childArgs);
  ...
  childProcess.execFile(binPath, childArgs, {
    ...
    // TODO we could maybe check the err but today the YSLOW
    // fails, sending error even if it works sometiomes,
    // think it is my fault though /peter :)
    {
