...
var fs = require('fs-extra'),
  ...
  cli = require('nomnom').options({
    ...
    uniqueOutputFolderName: {
      help: 'A unique name for the output folder. By default the folder name will be the date when you run the test like yyyy-mm-dd-HH-MM-ss'
    },
    userAgent: {
      metavar: '<USER-AGENT>',
