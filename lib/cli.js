...
var cli = nomnom.help(
	...
	onInitialize: {
		help: 'Supply a javascript that will execute before the browser start to load. Use it to set cookies, session, localStoage etc. which are used in page',
		default: defaultConfig.onInitialize
	},
	customScripts: {
