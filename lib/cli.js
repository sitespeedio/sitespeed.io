...
var cli = nomnom.help(
	...
	waitScript: {
		...
		default: 'return window.performance.timing.loadEventEnd > 0'
	},
	customScripts: {
		help: 'The path to an extra script folder with scripts that will be executed in the browser. See http://www.sitespeed.io/documentation/#customScripts'
	},
	btConfig: {
		metavar: '<FILE>',
	...
	graphiteData: {
		...
		help: 'Choose which data to send to Graphite by a comma separated list. Default all data is sent. [summary,rules,pagemetrics,timings,requesttimings]'
	},
	gpsiKey: {
...
if (cli.file) {
	console.log(JSON.stringify(cli.file));
