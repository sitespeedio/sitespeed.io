...
module.exports.parseCommandLine = function parseCommandLine() {
   ...
   */
    ...
    */
    ...
    .option('urlAlias', {
      describe:
        "Use an alias for the URL. If you don't  pass on the same amount of aliases as URLs the URL will be used as alias. Pass on multiple --urlAlias for multiple URLs.",
      type: 'string'
    })
    .option('utc', {
