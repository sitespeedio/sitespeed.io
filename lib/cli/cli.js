...
module.exports.parseCommandLine = function parseCommandLine() {
   ...
   */
    ...
    */
    ...
    .option('s3.extraClientParams', {
      describe:
        'Extra settings to pass to the s3 client, see: https://github.com/andrewrk/node-s3-client#create-a-client',
      group: 's3'
    })
    .option('s3.extraParams', {
      describe:
        'Extra options, see http://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/Config.html#constructor-property',
      group: 's3'
    })
    /**
     Html options
