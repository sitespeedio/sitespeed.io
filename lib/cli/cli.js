...
if (explicitOptions.config) {
  configFiles.unshift(explicitOptions.config);
}
...
module.exports.parseCommandLine = function parseCommandLine() {
  let parsed = yargs
    ...
    .option('browsertime.chrome.includeResponseBodies', {
      ...
      describe:
        'Include response bodies in the HAR file. At the moment we only support the HTML of the main request.',
      default: 'none',
      choices: ['none', 'html'],
      group: 'Chrome'
    })
