...
module.exports.parseCommandLine = function parseCommandLine() {
  let parsed = yargs
    ...
    .option('browsertime.visualMetrics', {
      ...
      type: 'boolean',
      describe:
        'Calculate Visual Metrics like SpeedIndex, First Visual Change and Last Visuaö Change. Requires FFMpeg and Python dependencies',
      group: 'Browser'
    })
   ...
   */
    ...
    .option('influxdb.regexp.tag.group', {
      default: influxdbConfig.regularExpData,
      describe:
        'Sets the regular expression that identifies the characters that will be replaced by the _ character in the tag group',
      group: 'InfluxDB'
    })
    .option('metrics.list', {
