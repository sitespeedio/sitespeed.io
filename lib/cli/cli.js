...
function validateInput(argv) {
  ...
  // TODO this is not right if you use alias with URLs in a file
  if (argv.urlAlias && argv._ && argv._.length !== argv.urlAlias.length) {
...
module.exports.parseCommandLine = function parseCommandLine() {
   ...
   */
    ...
    */
    ...
    .option('urlAlias', {
      describe:
        'Use an alias for the URL. You need to pass on the same amount of aliases as URLs. Pass on multiple --urlAlias for multiple URLs.',
      type: 'string'
    })
    .option('utc', {
