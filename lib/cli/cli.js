...
module.exports.parseCommandLine = function parseCommandLine() {
   ...
   */
    ...
    */
    ...
    .option('urlAlias', {
      describe:
        "Use an alias for the URL (if you feed URLs from a file you can instead have the alias in the file). If you don't  pass on the same amount of aliases as URLs the URL will be used as alias. The alias is used as the name of the URL on the HTML report and in Graphite/InfluxDB. Pass on multiple --urlAlias for multiple URLs.",
      type: 'string'
    })
    .option('utc', {
