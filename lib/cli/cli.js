...
module.exports.parseCommandLine = function parseCommandLine() {
   ...
   */
    ...
    .option('webpagetest.timeline', {
      describe: 'Activates chrome tracing. More Useful metrics but can slow down the test itself',
      type: 'boolean',
      default: false,
      group: 'WebPageTest'
    })
    .option('webpagetest.domainsDashboard', {
      describe: 'Record weight and requests for each domain to populate the grafana dashboard. Will take more disk space in graphite',
      type: 'boolean',
      default: false,
      group: 'WebPageTest'
    })
