...
module.exports.parseCommandLine = function parseCommandLine() {
   ...
   */
    ...
    */
    .option('ftp.host', {
      describe: 'The ftp host',
      group: 'ftp'
    })
    .option('ftp.port', {
      describe: 'The ftp port',
      group: 'ftp'
    })
    .option('ftp.user', {
      describe: 'The ftp user credentials',
      group: 'ftp'
    })
    .option('ftp.password', {
      describe: 'The ftp password credentials',
      group: 'ftp'
    })
    .option('ftp.removeLocalResult', {
      describe:
        'Remove all the local result files after they have been uploaded to ftp',
      default: false,
      type: 'boolean',
      group: 'ftp'
    })
