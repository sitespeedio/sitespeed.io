export function addOptions(yargs) {
  yargs
    ...
    .option('compare.mannwhitneyu.method', {
      choices: ['auto', 'exact', 'asymptotic'],
      describe:
        'Selects the method for calculating the Mann-Whitney U test. auto automatically selects between exact and asymptotic based on sample size, exact uses the exact distribution of U, and asymptotic uses a normal approximation.',
      default: 'auto',
      group: 'compare'
    });
}
