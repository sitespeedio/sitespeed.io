...
Graphite.prototype.sendPageData = function(aggregates, pages, cb) {
  ...
  if (this.config.graphiteData.indexOf('summary') > -1 || this.config.graphiteData.indexOf(
    'all') > -1) {
    statistics += this._getSummaryStats(aggregates, namespace, timeStamp);
  }
...
Graphite.prototype._getSummaryStats = function(aggregates, namespace, timeStamp) {
  var statistics = '';
    ...
    if (page.timings) {
      Object.keys(page.timings).forEach(function(timing) {
        timingsWeWillPush.forEach(function(val) {
          // is it a browser?
          if (this.config.supportedBrowsers.indexOf(timing) < 0) {
      ...
      Object.keys(page.timings).forEach(function(browser) {
        if (this.config.supportedBrowsers.indexOf(browser) > -1) {
