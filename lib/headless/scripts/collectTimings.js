...
system = require('system'),
  address, output, harfilename, w, h, agent, basicauth, auth, headers, waitScript, fs = require('fs'), onInitialize;

if (system.args.length < 7 || system.args.length > 11) {
