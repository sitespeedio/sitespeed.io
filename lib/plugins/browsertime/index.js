  ...
  async processMessage(message, queue) {
    ...
    switch (message.type) {
      ...
      case 'url': {
        ...
        // Override the group if you have choses one from the command linee
        if (
          group &&
          this.allOptions.urlsMetaData &&
          this.allOptions.urlsMetaData[url]
        ) {
          group = this.allOptions.urlsMetaData[url].groupAlias || group;
        }
