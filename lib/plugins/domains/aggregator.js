  ...
  return reduce(
    ...
    (summary, domainStats, domainName) => {
      const domainSummary = {
        ...
        totalTransferSize: domainStats.totalTransferSize,
        totalContentSize: domainStats.totalContentSize,
        domainName
      };
...
module.exports = {
  ...
  addToAggregate(har, url) {
    ...
    har.log.entries.forEach(entry => {
      ...
      domain.totalTransferSize += entry.response.bodySize;
      domain.totalContentSize +=
