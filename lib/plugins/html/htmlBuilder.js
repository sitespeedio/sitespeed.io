...
class HTMLBuilder {
  constructor(context, options) {
    ...
    // TODO in the future lets make it possible for plugins
    // to add their own links in the header
    headerLinks.push({ pug: 'index', name: 'Summary' });
    headerLinks.push({ pug: 'detailed', name: 'Detailed Summary' });
    headerLinks.push({ pug: 'pages', name: 'Pages' });
    //headerLinks.push({ pug: 'domains', name: 'Domains' });
    headerLinks.push({ pug: 'toplist', name: 'Toplist' });
    // headerLinks.push({ pug: 'assets', name: 'Assets' });
    // headerLinks.push({ pug: 'budget', name: 'Budget' });
    headerLinks.push({ pug: 'errors', name: 'Errors' });
  }

  addHeader(header) {
    headerLinks.push(header);
  }
