...
class HTMLBuilder {
  ...
  _renderUrlPage(url, name, locals) {
    ...
    locals = merge({
      ...
      pageDescription: metricHelper.getMetricsFromPageSummary(locals) + ' collected by sitespeed.io',
  ...
  _renderUrlRunPage(url, name, locals) {
    ...
    locals = merge({
      ...
      pageDescription: metricHelper.getMetricsFromRun(locals) + ' collected by sitespeed.io',
      headers: this.summary,
      version: packageInfo.version,
