...
const keyify = require('../../support/helpers/').keyify;
...
const defaultConfig = {
  html: {
    ...
    summaryBoxes: keyify(friendlyNames)
    // summaryBoxes: [
    //   'coach.score',
    //   'coach.performance.score',
    //   'coach.accessibility',
    //   'coach.bestpractice',
    //   'coach.performance.fastRender',
    //   'coach.performance.avoidScalingImages',
    //   'coach.performance.compressAssets',
    //   'coach.performance.optimalCssSize',
    //   'pagexray.transferSize',
    ...
    //   'pagexray.requests.font',
    //   'pagexray.responseCodes.200',
    //   'pagexray.responseCodes.301',
    //   'pagexray.responseCodes.404',
    //   'pagexray.domains',
    //   'pagexray.expireStats',
    //   'pagexray.lastModifiedStats',
    //   'pagexray.firstParty',
    //   'pagexray.thirdParty',
    //   'browsertime.rumSpeedIndex',
    //   'browsertime.firstPaint',
    //   'browsertime.pageTimings.backEndTime',
    //   'browsertime.pageTimings.frontEndTime',
    //   'browsertime.pageTimings.pageLoadTime',
    //   'browsertime.fullyLoaded',
    //   'browsertime.visualMetrics.FirstVisualChange',
    //   'browsertime.visualMetrics.SpeedIndex',
    //   'browsertime.visualMetrics.PerceptualSpeedIndex',
    //   'browsertime.visualMetrics.VisualComplete85',
    //   'browsertime.visualMetrics.VisualComplete95',
    //   'browsertime.visualMetrics.VisualComplete99',
    //   'browsertime.visualMetrics.LastVisualChange',
    //   'browsertime.visualMetrics.LargestImage',
    //   'browsertime.visualMetrics.Heading',
    //   'browsertime.visualMetrics.Logo',
    //   'browsertime.custom',
    //   'browsertime.cpu.tasks',
    //   'browsertime.cpu.totalDuration',
    //   'webpagetest.firstView.render',
    //   'webpagetest.firstView.SpeedIndex',
    //   'webpagetest.firstView.fullyLoaded'
    // ]
  }
};
