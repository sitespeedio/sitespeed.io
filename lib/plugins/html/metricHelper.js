module.exports = {
  ...
  getMetricsFromRun(locals) {
    ...
    } else if (locals.pageInfo.data.browsertime && locals.pageInfo.data.browsertime.run) {
  ...
  getMetricsFromPageSummary(locals) {
    ...
    } else if (locals.pageInfo.data.browsertime && locals.pageInfo.data.browsertime.pageSummary) {
