...
module.exports = function(data) {
  ...
  if (browsertime) {
    ...
    boxes.push(box('RUM Speed Index', browsertime.summary.rumSpeedIndex, undefined, 'rumSpeedIndex'));
    boxes.push(box('First Paint', browsertime.summary.firstPaint, undefined, 'firstPaint', h.time.ms));
    boxes.push(box('Backend Time', browsertime.summary.timings.backEndTime, undefined, 'backEndTime', h.time.ms));
    boxes.push(box('Frontend Time', browsertime.summary.timings.frontEndTime, undefined, 'frontEndTime', h.time.ms));
    boxes.push(box('Fully Loaded Time', browsertime.summary.fullyLoaded, undefined, 'fullyLoaded', h.time.ms))
  ...
  if (webpagetest) {
    ...
    boxes.push(box('WPT SpeedIndex (firstView)', webpagetest.summary.firstView.SpeedIndex, undefined, 'speedIndex'));
