...
globalThis.addEventListener('DOMContentLoaded', function () {
  ...
  // #video and #filmstrip used to be tabs of their own; they are merged
  // into the Rendering tab but old deep links must keep opening it. The
  // original hash stays in the URL so the anchors with those ids inside
  // the section keep working.
  const tabAliases = { '#video': '#rendering', '#filmstrip': '#rendering' };
