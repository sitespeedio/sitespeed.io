...
globalThis.addEventListener('DOMContentLoaded', function () {
  ...
  // The CPU tab links to the Long Animation Frames deep-dive on the
  // Metrics tab; a reload or shared link with that hash must open it.
  const tabAliases = {
    '#video': '#rendering',
    '#filmstrip': '#rendering',
