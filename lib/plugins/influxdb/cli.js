module.exports = {
  ...
  username: {
    describe:
      'The InfluxDB username for your InfluxDB instance.(Use with version 1 only)',
    group: 'InfluxDB'
  },
  password: {
    describe:
      'The InfluxDB password for your InfluxDB instance.(Use with version 1 only)',
    group: 'InfluxDB'
  },
  organisation: {
    describe:
      'The InfluxDB organisation for your InfluxDB instance.(Use with version 2 only)',
    group: 'InfluxDB'
  },
  token: {
    describe:
      'The InfluxDB token for your InfluxDB instance.(Use with version 2 only)',
    group: 'InfluxDB'
  },
  version: {
    default: 1,
    describe: 'The InfluxDB version of your InfluxDB instance. (default is 1)',
    type: 'int',
    group: 'InfluxDB'
  },
  database: {
