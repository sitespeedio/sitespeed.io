...
module.exports = {
  ...
  messages: {
    describe:
      'Choose what type of message to send to Matrix. There are three types of messages: Error messages, budget messages and a message when the test is done. Errors are errors that happens through the tests (failures like strarting a test) and budget is test failing against your budget.',
