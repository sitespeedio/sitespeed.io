...
module.exports = {
  ...
  greenVsGreyDomains(greenchecks) {

    return {
      green: Object.values(greenchecks).filter(function (obj) { return obj.green }),
      grey: Object.values(greenchecks).filter(function (obj) { return !obj.green })
    }
  }
};
