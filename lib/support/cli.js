...
module.exports.parseCommandLine = function parseCommandLine(browsertimeOptions) {
  let parsed = yargs
    ...
    .alias('browsertime.connectivity.downstreamKbps', 'downstreamKbps')
    .alias('browsertime.connectivity.upstreamKbps', 'upstreamKbps')
    .alias('browsertime.connectivity.latency', 'latency')
