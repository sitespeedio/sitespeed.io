...
module.exports.parseCommandLine = function parseCommandLine() {
  ...
  .option('crawler.depth', {
    ...
    .option('elasticsearch.host', {
      default: elasticsearchConfig.host,
    ...
    .option('elasticsearch.includeQueryParams', {
      ...
      describe: 'Whether to include query parameters from the URL in the Elasticsearch alias or not.',
      type: 'boolean',
      group: 'Elasticsearch'
	})
    .option('elasticsearch.fieldsLimit', {
      default: elasticsearchConfig.fieldsLimit,
      describe: 'Increase default fields limit of Elasticsearch from 1000 to defined value.',
      type: 'boolean',
      group: 'Elasticsearch'
    })
