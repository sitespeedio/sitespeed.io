...
OPTIONS:
   ...
   -l      The page score limit. Below this page score it will be an error. Default is 90. [optional]
   -a      The average score limit for all tested pages, below this score it will be an error. Default is 90. [optional]	
