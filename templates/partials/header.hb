<head>
  ...
  <link rel="stylesheet" href="{{pageMeta.path}}css/bootstrap.min.css" type="text/css">
  <link rel="stylesheet" href="{{pageMeta.path}}css/bootstrap-overrides.css" type="text/css">

<link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{pageMeta.path}}img/ico/sitespeed.io-144.png">
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{pageMeta.path}}img/ico/sitespeed.io-114.png">
<link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{pageMeta.path}}img/ico/sitespeed.io-72.png">
<link rel="apple-touch-icon-precomposed" href="{{pageMeta.path}}img/ico/sitespeed.io-57.png">
<link rel="shortcut icon" href="{{pageMeta.path}}img/ico/sitespeed.io.ico">
...
<div class="navbar-header">
    ...
    <img src="{{pageMeta.path}}img/sitespeed-logo.png" class="navbar-brand" alt="Sitespeed.io - How speedy is your site?" width="162" height="50"/>
  </div>
